...
sudo ovn-nbctl lsp-set-addresses vm1 "40:44:00:00:00:01 192.168.50.21"
sudo ovn-nbctl lsp-set-addresses vm2 "40:44:00:00:00:02 192.168.50.22"
sudo ovn-nbctl show
...
sudo ip netns exec vm1 ip addr add 192.168.50.21/24 dev vm1
...
sudo ip netns exec vm2 ip addr add 192.168.50.22/24 dev vm2
